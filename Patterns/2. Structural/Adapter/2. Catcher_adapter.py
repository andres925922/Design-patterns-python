...
class LineToPointAdapter():         # We stop hinheriting from list since the adapter is no longer a list
    # points_counter = 0
    cache = {}                      # We create a cache with all the instances
